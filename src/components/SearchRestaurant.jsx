...
const SearchRestaurant = ({
  data:{
    card:{
      card:{
          info:{id, cloudinaryImageId, aggregatedDiscountInfoV3={}, cuisines , promoted=false, costForTwoMessage, name, avgRating, sla:{slaString}}
      },
    },
  }
}) => {
...
<div className="w-[30%]">
<img className="aspect-square rounded-lg" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/"+cloudinaryImageId} alt=""></img>
</div>
<div className="w-[60%]">
